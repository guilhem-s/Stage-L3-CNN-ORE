...
def create_data(IM_DIR, ethnie, proportion): 
    ...
    nb_reduit = int(56*proportion / (100-proportion)) #nb d'images à conserver de l'ethnie à réduire
...
def create_model(nb_cc_value, myconv, nb_im): #from pre-trained conv layers
    ...
    #model.add(tensorflow.keras.layers.InputLayer(input_shape=(224,224,3), batch_size=32))
